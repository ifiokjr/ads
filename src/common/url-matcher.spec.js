...
describe( 'matcher', function( ) {
  ...
  it( 'provides captured parameters correctly', function( ) {
    ...
    expect( match.one ).to.equal('one');
  });

  it( 'should fail with the wrong object and params', function( ) {
    var match = m.match( urlObjFail );
    expect( match[matcher.MATCH_PROPERTY] ).to.equal(false);
  });
